...
class SNAKE:
    def __init__(self):
        ...
        self.crunch_sound = pygame.mixer.Sound('temp/crunch.mp3')
    ...
    def update_head(self):
        ...
        elif head_change == Vector2(-1,0): self.head = self.head_right
        elif head_change == Vector2(0,1): self.head = self.head_up
        elif head_change == Vector2(0,-1): self.head = self.head_down

    def update_tail(self):
        tail_change = self.body[-2] - self.body[-1]
        if tail_change == Vector2(1,0): self.tail = self.tail_left
        elif tail_change == Vector2(-1,0): self.tail = self.tail_right
        elif tail_change == Vector2(0,1): self.tail = self.tail_up
        elif tail_change == Vector2(0,-1): self.tail = self.tail_down
...
apple = pygame.image.load('temp/fruit.png').convert_alpha()
